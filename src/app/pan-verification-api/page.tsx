...
const PANVerificationPageApi: React.FC = () => {
          ...
          <div className="container mx-auto px-4 py-10 flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="w-full md:w-2/3 text-white">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Verify PAN Cards Instantly with Complete Accuracy
              </h1>
              <h2 className="text-xl md:text-2xl font-semibold mb-6 text-[#f6fbfc]">
                Ensure tax compliance, prevent fraud, and streamline KYC
                processes with our comprehensive PAN Verification APIs.
              </h2>
              <p className="text-lg mb-4 text-white">
                Our PAN Verification API provides instant validation of PAN card
                details with both normal and detailed verification options,
                ensuring complete tax compliance and identity authentication.
              </p>
              <p className="mb-4 text-white">
                From basic PAN validation to detailed cardholder information, we
                offer comprehensive verification methods to meet your specific
                business requirements and regulatory compliance needs.
              </p>
              <p className="mb-6 text-white">
                Trusted by financial institutions, fintech companies, and
                businesses across India to ensure authentic PAN verification and
                prevent tax-related fraud.
              </p>
              ...
              <div className="grid gap-8 grid-cols-1 md:grid-cols-5">
                <div className="text-center relative">
                  ...
                  <p className="text-gray-600 text-sm">
                    User enters PAN number and cardholder name for verification
                  </p>
                </div>
                <div className="text-center relative">
                  <div className="w-16 h-16 bg-[#b7603d] rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-4 relative z-10">
                  ...
                  <p className="text-gray-600 text-sm">
                    System validates PAN format and structure compliance
                  </p>
                </div>
                <div className="text-center relative">
                  <div className="w-16 h-16 bg-[#b7603d] rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-4 relative z-10">
                  ...
                  <p className="text-gray-600 text-sm">
                    API queries Income Tax Department database for verification
                  </p>
                </div>
                <div className="text-center relative">
                  <div className="w-16 h-16 bg-[#b7603d] rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-4 relative z-10">
                  ...
                  <p className="text-gray-600 text-sm">
                    Cross-reference provided name with official PAN records
                  </p>
                </div>
                <div className="text-center relative">
                  <div className="w-16 h-16 bg-[#b7603d] rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-4 relative z-10">
                  ...
                  <p className="text-gray-600 text-sm">
                    Receive verification status and detailed information
                  </p>
                </div>
              </div>
            </div>
 ...
 py-16 px-4 md:px-8 lg:px-20"
        >
          <div className="w-full mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-12">
              Why Use Our{" "}
              <span className="text-[#b7603d]">PAN Verification API</span>?
            </h2>
   ...
   rounded-full flex items-center justify-center mr-4"
                ...
                <p className="text-gray-600 text-sm">
                  Get PAN verification results in 1-3 seconds with direct access
                  to Income Tax databases.
                </p>
              </div>
 ...
 rounded-full flex items-center justify-center mr-4"
                ...
                <p className="text-gray-600 text-sm">
                  Detect fake or invalid PAN cards to prevent identity fraud and
                  financial crimes.
                </p>
              </div>
  ...
  rounded-full flex items-center justify-center mr-4"
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 text-sm">
                  Bank-grade security with end-to-end encryption for all PAN
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 text-sm">
                  Access comprehensive PAN details including name, DOB, and
                  verification status.
                </p>
              </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="w-full lg:w-1/2 space-y-6">
                ...
                <p className="text-gray-600">
                  Integrate PAN verification seamlessly into your applications
              ...
              <div className="w-full lg:w-1/2">
                <div className="bg-gray-900 rounded-lg p-6 text-green-400 font-mono text-sm overflow-x-auto">
                  ...
                  <span className="text-white">/api/v1/pan-verification</span>
