          ...
          <div className="container mx-auto px-4 py-10 flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="w-full md:w-2/3 text-white">
              ...
              <p className="text-lg mb-4 text-white">
                ...
                validation of bank account details across all major Indian
                banks, ensuring secure and accurate financial transactions.
              </p>
              ...
              <p className="mb-6 text-white">
                Trusted by fintech companies, e-commerce platforms, and
                financial institutions to reduce failed payouts, prevent fraud,
                and enhance customer trust through reliable account
                verification.
              </p>
