                  ...
                  >
                    ...
                    >
                      <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                        <motion.img
                          src="/ui/MCA-VERIFICATION/img2_Artboard 1.png"
                          alt="MCA Verification Illustration"
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                ...
                Why We're A Trusted Partner For Company Verification API.
              ...
              <div className="space-y-8">
                <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                  ...
                  <p className="text-lg leading-relaxed text-white/90">
                    7uniqueverify is an actual company verification API and a reliable platform in India that enables companies to quickly verify a company. The Company Verification API can be utilized to verify corporate company information, mitigate fraud, and mitigate the risk of compliance for banks and firms.                                                                                                           </p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                  ...
                  <p className="text-lg leading-relaxed text-white/90">
                    ...
                    7uniqueverify gives clients access to real corporate records from the Ministry of Corporate Affairs with the MCA Verification API Service India, which thereby helps with the company's authenticity, the existence of top-class directors, and much organizational compliance.                                                         </p>
                </div>
              </div>
              ...
              <div className="space-y-8">
                <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                  ...
                  <p className="text-lg leading-relaxed text-white/90">
                    ...
                    <a href="https://www.7uniqueverfiy.com" className="font-bold  underline"> 7uniqueverify </a>  provides banks, fintech platforms, and corporate service providers with MCA Data API Service India that is integrated, real-time company verification and reduces the chances of working with unverified or fraudulent entities.                                                                                    </p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                  ...
                  <p className="text-lg leading-relaxed text-white/90">
                    As a consistent provider of the CIN Verification API in India, we ensure scalable, secure, and easy-to-integrate solutions. Businesses can automate corporate verification, drive trust, and carry out business with accurate details of a company.                  </p>
                </div>
              </div>
            </div>
