        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              ...
              Reasons to Consider Us for IMEI Verification API’s  Services
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-8">
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                ...
                <p className="text-lg leading-relaxed text-white/90">
                  7uniqueverify offers the most trustworthy LEI API for businesses for simple verification of Legal Entity Identifiers as part of the global compliance journey. We verify that your organization’s data is accurate for a smoother compliance experience.                                       </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                ...
                <p className="text-lg leading-relaxed text-white/90">
                  ...
                  We offer a compelling IMEI API for businesses as well that ensures quick verification of mobile device authenticity. Our API for IMEI verification in real time will help you prevent fraud and ensure your products are authentic.                                                 </p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                ...
                <p className="text-lg leading-relaxed text-white/90">
                  With our IMEI validation API, you can easily validate the IMEI (or serial) numbers of mobile devices and ensure they are registered for regulatory compliance.
                  We give businesses the tools they need to prevent counterfeit and stolen goods from entering their organization with their IMEI numbers.
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                ...
                <p className="text-lg leading-relaxed text-white/90">
                  Establish a relationship with <a href="https://www.7uniqueverfiy.com" className="font-bold  underline"> 7uniqueverify </a> for a reliable, secure, and efficient IMEI validation API to help avoid risks and ensure a seamless business experience.                                 </p>
              </div>
            </div>
          </div>
