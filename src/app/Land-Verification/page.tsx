  ...
  return (
    <main className="w-full mx-auto">
      ...
      >
        <div className="container mx-auto px-4 py-10 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <img
              src="/ui/land-verification/img_Artboard 1.png"
              ...
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800">
                    Khasra/Survey • Khata/Account • Owner Name
                  </h3>
      ...
      <section className="bg-white py-16 px-4 md:px-8 lg:px-20">
        <div className="w-full mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-12">
            How <span className="text-[#b7603d]">Land Verification</span> Works
          </h2>
          ...
          >
            <div className="flex flex-wrap justify-center gap-6 text-sm">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>Encumbrance insights</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="w-full lg:w-1/2 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-[#b7603d]">✓</span>
                  <span>Search by Khasra/Survey, Khata, or Owner name</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span className="text-[#b7603d]">✓</span>
                  <span>
            ...
            <div className="w-full lg:w-1/2">
              <div className="bg-gray-900 rounded-lg p-6 text-green-400 font-mono text-sm overflow-x-auto">
                ...
                <span className="text-white">/api/v1/land-verify</span>
                ...
                <div className="ml-4 text-white">"search_mode": "khasra",</div>
                <div className="ml-4 text-white">"state": "Rajasthan",</div>
                <div className="ml-4 text-white">"district": "Jaipur",</div>
                <div className="ml-4 text-white">"tehsil": "Sanganer",</div>
                <div className="ml-4 text-white">"village": "Jagatpura",</div>
