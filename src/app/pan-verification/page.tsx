          ...
          <div className="max-w-6xl mx-auto relative z-10">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                ...
                Why We Are a Trusted Partner for the PAN Verification API
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-8">
                <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                  ...
                  <p className="text-lg leading-relaxed text-white/90">
                    7uniqueverify offers a safe and dependable PAN Card Verification API that supports businesses to authenticate their users' PAN details instantly. It also aids in accuracy, reduces fraud, and supports compliance with regulations within the financial services sector, fintech, and enterprises.                      </p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                  ...
                  <p className="text-lg leading-relaxed text-white/90">
                    Using our advanced API for PAN verification, businesses will be able to validate a PAN number, name, and other details quickly and verifiably from legitimate sources. This is an important component of the user onboarding process and helps verify identity, and businesses can run their digital life without having to worry about errors.                                     </p>
                </div>
              </div>
              ...
              <div className="space-y-8">
                <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                  ...
                  <p className="text-lg leading-relaxed text-white/90">
                    Our PAN Number Verification API is meant for banks, NBFCs (non-bank financial companies), e-commerce platforms, and any digital service provider. Our services allow customers to quickly and easily verify to eliminate fake entries and allow your business to work only with authenticated and verifiable customers.                             </p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                  ...
                  <p className="text-lg leading-relaxed text-white/90">
                    <a href="https://www.7uniqueverfiy.com" className="font-bold  underline"> 7uniqueverify </a> is a reliable provider of PAN Validation API in India. Our service provides solid capacity, easy integration, and represents a good, scalable solution for your business to complete real-time verifications, simple onboarding, and more secure ID verification checks for your secure business operation.
                  </p>
                </div>
              </div>
            </div>
