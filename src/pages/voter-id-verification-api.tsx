        ...
        <div className="relative w-full mx-auto px-6 sm:px-10 md:px-16 lg:px-20 xl:px-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl mb-8 text-purple-100">
              Verify electoral identity instantly with our comprehensive Voter
              ID verification service
            </p>
            <p className="text-lg mb-10 text-purple-200 max-w-3xl mx-auto">
              Validate Voter ID details against official Election Commission
              databases for reliable identity verification and address proof
              validation.
            </p>
...
"
  ...
  rounded-full flex items-center justify-center mx-auto mb-6"
              ...
              <p className="text-gray-600">
                Verify citizen identity for government services, welfare
                schemes, and official document issuance.
              </p>
            </div>
  ...
  rounded-full flex items-center justify-center mx-auto mb-6"
              ...
              <p className="text-gray-600">
                Use Voter ID as address proof for KYC compliance and customer
                onboarding in banking and finance.
              </p>
            </div>
  ...
  rounded-full flex items-center justify-center mx-auto mb-6"
              ...
              <p className="text-gray-600">
                Verify user identity for digital platforms, e-commerce, and
      ...
      >
        <div className="w-full mx-auto px-6 sm:px-10 md:px-16 lg:px-20 xl:px-24">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Simple 4-step process to verify Voter ID details
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Send Voter ID number and basic details through our secure API
                endpoint.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We verify the details against official Election Commission
                databases.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Advanced algorithms validate the voter information and address
                details.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Receive comprehensive verification results with voter details
                and status.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Get started with our Voter ID verification API in minutes with
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  <svg
                    className="w-6 h-6 text-[#b7603d]   mr-3"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
            ...
            <div className="bg-gray-900 rounded-lg p-6 overflow-x-auto">
              <div className="text-green-400 font-mono text-sm">
                ...
                <div className="text-blue-400 ml-2">
                  https://api.example.com/v1/voter-verification \
                </div>
                <div className="text-blue-400 ml-2">
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-indigo-700 text-white">
        <div className="w-full mx-auto px-6 sm:px-10 md:px-16 lg:px-20 xl:px-24 text-center">
          ...
          <p className="text-xl mb-10 text-purple-100 max-w-3xl mx-auto">
            Join thousands of businesses using our Voter ID verification API to
