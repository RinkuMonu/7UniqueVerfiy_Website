...
const NameMatchPageAPI: React.FC = () => {
    ...
    <main className="w-full mx-auto">
          ...
          <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-lg text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm mb-3">
                Verify customer names across multiple documents for account
                opening and loan processing.
              </p>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-lg text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm mb-3">
                Ensure name consistency across KYC documents for regulatory
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-lg text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm mb-3">
                Detect identity fraud by comparing names across different
                verification sources and documents.
              </p>
              <div className="text-xs text-[#b7603d] font-medium">
                "Fraud detection!"
              </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-6 rounded-lg text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm mb-3">
                Verify cardholder names against account names for secure payment
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 p-6 rounded-lg text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm mb-3">
                Match patient names across medical records and insurance
                documents for accurate healthcare delivery.
              </p>
            ...
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 p-6 rounded-lg text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm mb-3">
                Identify duplicate records and merge customer data by matching
      ...
      <section className="bg-[#f7f1ef] py-16 px-4 md:px-8 lg:px-20">
        <div className="w-full mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-12">
            Choose Your{" "}
            <span className="text-[#b7603d]">Name Matching Method</span>
          </h2>
          <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
            {/* <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-blue-500">
              ...
              <p className="text-gray-600 mb-4">
                Performs exact string comparison between names, ideal for strict
                verification requirements and regulatory compliance.
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-green-500">
              ...
              <p className="text-gray-600 mb-4">
                Uses advanced algorithms to match names with variations,
                nicknames, and cultural differences with confidence scores.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-gray-500">Response Time:</span>
            ...
            <div className="grid gap-8 grid-cols-1 md:grid-cols-5">
              <div className="text-center relative">
                ...
                <p className="text-gray-600 text-sm">
                  Provide two names to compare and match type preference
                </p>
              </div>
              <div className="text-center relative">
                <div className="w-16 h-16 bg-[#b7603d] rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-4 relative z-10">
                ...
                <p className="text-gray-600 text-sm">
                  Clean and normalize names for accurate comparison
                </p>
              </div>
              <div className="text-center relative">
                <div className="w-16 h-16 bg-[#b7603d] rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-4 relative z-10">
                ...
                <p className="text-gray-600 text-sm">
                  Apply matching algorithms based on selected method
                </p>
              </div>
              <div className="text-center relative">
                <div className="w-16 h-16 bg-[#b7603d] rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-4 relative z-10">
                ...
                <p className="text-gray-600 text-sm">
                  Calculate match confidence and similarity percentage
                </p>
              </div>
              <div className="text-center relative">
                <div className="w-16 h-16 bg-[#b7603d] rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-4 relative z-10">
                ...
                <p className="text-gray-600 text-sm">
                  Receive detailed match results with confidence scores
                </p>
              </div>
            </div>
          </div>
 ...
 py-16 px-4 md:px-8 lg:px-20"
   ...
   rounded-full flex items-center justify-center mr-4"
              ...
              <p className="text-gray-600 text-sm">
                Get name match results in 1-3 seconds with optimized algorithms
 ...
 rounded-full flex items-center justify-center mr-4"
              ...
              <p className="text-gray-600 text-sm">
                Advanced machine learning algorithms handle complex name
  ...
  rounded-full flex items-center justify-center mr-4"
              ...
              <p className="text-gray-600 text-sm">
                Get detailed confidence scores to make informed decisions about
                name matches and verification.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm">
                Handle names from different cultures, languages, and naming
                conventions with high accuracy.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm">
                Detect potential identity fraud by identifying inconsistent name
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="w-full lg:w-1/2 space-y-6">
              ...
              <p className="text-gray-600">
                Integrate name matching seamlessly into your applications with
            ...
            <div className="w-full lg:w-1/2">
              <div className="bg-gray-900 rounded-lg p-6 text-green-400 font-mono text-sm overflow-x-auto">
                ...
                <span className="text-white">/api/v1/name-match</span>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              ...
              Why Should You Choose Us for the Name Match Verification API?
            ...
            <div className="space-y-8">
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                ...
                <p className="text-lg leading-relaxed text-white/90">
                  7uniqueverify is a secure and trustworthy Name Match Verification API in India used for business name verification of customers during the onboarding process. Our product accurately verifies the identity of an individual through name matching and helps reduce fraud, plus supports any enterprise or digital platform's compliance and regulation.                      </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                ...
                <p className="text-lg leading-relaxed text-white/90">
                  ...
                  With our Name Match KYC API India, organizations can verify the names of their customers against actual KYC records in real time. This reduces the risk of potential mismatches and increases trust while ensuring risk-free and smooth onboarding for banks, fintechs, and service providers.                                             </p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                ...
                <p className="text-lg leading-relaxed text-white/90">
                  ...
                  Our Name Matching API India is geared for startups, financial institutions, or digital platforms. It allows for quick, effortless integration and confirmed accuracy with real-time, reliable, consistent customer confirmation.                                  </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 group hover:shadow-xl">
                ...
                <p className="text-lg leading-relaxed text-white/90">
                  As a trusted name verification partner, <a href="https://www.7uniqueverfiy.com" className="font-bold  underline"> 7uniqueverify </a> offers powerful, easy, and reliable name verification solutions that will enable enterprises to improve their Know Your Customer process, improve their security, and process rules and guidelines in a compliant manner while providing a seamless digital customer experience.     </p>
              </div>
            </div>
          </div>
