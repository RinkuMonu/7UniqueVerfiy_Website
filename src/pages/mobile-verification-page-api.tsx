...
const MobileVerificationPageAPI: React.FC = () => {
        ...
        <div className="container mx-auto px-4 py-10 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="w-full md:w-2/3 text-white">
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-6 text-[#f6fbfc]">
              Validate mobile numbers, carrier details, and user identity with
              our Mobile Verification API.
            </h2>
            <p className="text-lg mb-4 text-white">
              Our Mobile API provides real-time verification of phone numbers
              across all Indian carriers.
            </p>
            <p className="mb-4 text-white">
              From basic number validation to detailed carrier lookups, we offer
              comprehensive verification methods to meet your business needs.
            </p>
            <p className="mb-6 text-white">
              Trusted by financial institutions, e-commerce platforms, and
              businesses across India to verify users and prevent fraud.
            </p>
      ...
      <section className="bg-white py-16 px-4 md:px-8 lg:px-20">
        <div className="w-full mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-12">
            Where Can You Use{" "}
            <span className="text-[#b7603d]">Mobile Verification</span>?
          </h2>
 ...
 py-16 px-4 md:px-8 lg:px-20"
      ...
      <section className="bg-white py-16 px-4 md:px-8 lg:px-20">
        <div className="w-full mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-12">
            How <span className="text-[#b7603d]">Mobile Verification</span>{" "}
            Works
          </h2>
            ...
            <div className="grid gap-8 grid-cols-1 md:grid-cols-5">
              <div className="text-center relative">
                ...
                <p className="text-gray-600 text-sm">
                  Enter 10-digit mobile number for verification
                </p>
              </div>
              <div className="text-center relative">
                <div className="w-16 h-16 bg-[#b7603d] rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-4 relative z-10">
                ...
                <p className="text-gray-600 text-sm">
                  System validates number format and structure
                </p>
              </div>
              <div className="text-center relative">
                <div className="w-16 h-16 bg-[#b7603d] rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-4 relative z-10">
                ...
                <p className="text-gray-600 text-sm">
                  API queries telecom operator databases
                </p>
              </div>
              <div className="text-center relative">
                <div className="w-16 h-16 bg-[#b7603d] rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-4 relative z-10">
                ...
                <p className="text-gray-600 text-sm">
                  Checks active status and carrier details
                </p>
              </div>
              <div className="text-center relative">
                <div className="w-16 h-16 bg-[#b7603d] rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-4 relative z-10">
                ...
                <p className="text-gray-600 text-sm">
                  Receive verification status and carrier info
                </p>
              </div>
            </div>
          </div>
 ...
 py-16 px-4 md:px-8 lg:px-20"
      >
        <div className="w-full mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-12">
            Why Use Our{" "}
            <span className="text-[#b7603d]">Mobile Verification API</span>?
          </h2>
   ...
   rounded-full flex items-center justify-center mr-4"
              ...
              <p className="text-gray-600 text-sm">
                Get mobile verification in 1-3 seconds with direct carrier
                access.
              </p>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="w-full lg:w-1/2 space-y-6">
              ...
              <p className="text-gray-600">
                Integrate mobile verification seamlessly into your applications
            ...
            <div className="w-full lg:w-1/2">
              <div className="bg-gray-900 rounded-lg p-6 text-green-400 font-mono text-sm overflow-x-auto">
                ...
                <span className="text-white">/api/v1/mobile-verification</span>
