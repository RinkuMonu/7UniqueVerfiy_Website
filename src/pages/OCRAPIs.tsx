  ...
  const ocrServices = [
    {
      ...
      icon: <FaPassport />,
      description:
        "Automatically extract personal and travel data from passport images using advanced OCR.",
    },
    {
      name: "PAN OCR",
      icon: <FaAddressCard />,
    ...
    // },
    {
      ...
      description:
        "Read cheque numbers, account info, and signatures for automated cheque processing.",
    },
    {
      name: "Aadhaar OCR",
      icon: <FaIdCard />,
          ...
          >
            {ocrServices.map((service, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-center text-gray-800 mb-3 group-hover:text-[#b7603d] transition-colors duration-300">
                  {service.name}
                </h3>
